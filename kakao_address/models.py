...
class KakaoAddressMixin(models.Model):
    zipcode = models.CharField('우편번호', max_length=10, help_text='국가기초구역번호. 2015년 8월 1일부터 시행되는 새 우편번호')
    address1 = models.CharField('주소', max_length=200)
    address2 = models.CharField('상세주소', max_length=100)
    address3 = models.CharField('상세주소 참고항목', max_length=100)

    class Meta:
        abstract = True


class KakaoAddressDetailMixin(models.Model):
